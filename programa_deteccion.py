...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.progressbar_image_frame.set(0)
        ...
        self.progressbar_inference_video = customtkinter.CTkLabel(self.video_frame, text="PROGRESO:\n VIDEO(S): 0/0", font=("Microsoft GothicNeo Bold", 12), anchor = "w")
        ...
        self.progressbar_video_frame.grid(row=2, column=2, padx=(0,1)) 
        ...
        self.video_inference_reset_button = customtkinter.CTkButton(self.video_frame, text="Resetear", command = self.video_inference_reset_button_event, anchor="center", height = 50) 
        self.video_inference_reset_button.grid(row=3, column=2, padx=(200,0), pady=(0,0))

        self.video_inference_start_button = customtkinter.CTkButton(self.video_frame, text="Empezar", command = self.video_inference_start_button_event, anchor="center", height = 50)
        self.video_inference_start_button.grid(row=4, column=2, padx=(0,200), pady=(0,0))

        self.video_inference_infographic_button = customtkinter.CTkButton(self.video_frame, text="Infografía", command = self.video_inference_infographic_button_event, anchor="center", height= 50) 
...
#Functions image
    ...
    def image_inference_reset_button_event(self):
        ...
        self.image_inference_start_button.configure(state="disabled")
        self.image_inference_infographic_button.configure(state="disabled")
        self.inference_image_image.configure(image=self.video_inference_image)
        self.progressbar_inference_info_image.configure(text="FPS: -- \n Tiempo de inicio: --:--:-- \n Tiempo de inferencia: --:--:--")
        self.progressbar_image_frame.set(0)
        self.progressbar_inference_status_image.configure(text='0%(0/0)')
...
#Functions video
    ...
    def video_inference_reset_button_event(self):
        ...
        self.progressbar_inference_status_video.configure(text='0%(0/0)')
        app.update_idletasks()
...
#Functions streaming
    ...
    def streaming_inference_reset_button_event(self):
        ...
        self.streaming_inference_start_button.configure(state="disabled")
        self.streaming_inference_infographic_button.configure(state="disabled")
        self.inference_streaming_image.configure(image=self.video_inference_image)
        self.progressbar_inference_info_streaming.configure(text="FPS: -- \n Tiempo de inicio: --:--:-- \n Tiempo de inferencia: --:--:--")
        app.update_idletasks()
...
#Inference Function    
            ...
            try:
                ...
                if not dt[1].dt:
                    ...
                    if infer_2 >= 1: #At least one second of inference has passed
                        ...
                        if len(det):
                            time_infe = datetime.datetime.now()
                        else:
                        ...
                        if self.switch_frame == 0:
                            ...
                            s_string = str(s)
                            s_space = s_string.find(" ")
                            s_slash = s_string.find("/")
                            s_space_2 = s_string.find(" ",s_slash)
                            video_current = s_string[s_space+1:s_slash]
                            video_total = s_string[s_slash+1:s_space_2]                  
                        ...
                        if self.switch_frame == 0:
                            self.inference_image_image.configure(image=im0_img)
                            list_1 = s.split("/")
                            frame_number_1 = list_1[0].split()[-1]
                            frame_number_2 = list_1[1].split()[0]
                        elif self.switch_frame == 1:
                            ...
                            self.inference_streaming_image.configure(image=im0_img)

                        if (self.switch_frame == 0) or (self.switch_frame == 1):
                            frame_numbers=int(frame_number_1)/int(frame_number_2)
                            if self.switch_frame == 0:
                                self.progressbar_image_frame.set(frame_numbers)
                                self.progressbar_inference_status_image.configure(text=str(int(frame_numbers*100))+ '%' + '' + '(' + str(frame_number_1) + '/' + str(frame_number_2) + ')')
                            elif self.switch_frame == 1:
    ...
    def parse_opt(self):
        ...
        if self.switch_frame == 0:
            self.opt.source = self.image_select_source_folder
            self.opt.project = self.image_select_folder
        elif self.switch_frame == 1:
            self.opt.source = self.video_select_source_folder
            self.opt.project = self.video_select_folder
        else :
            self.opt.source = self.streaming_select_source_folder
            self.opt.project = self.streaming_select_folder      
    ...
    def infographic_func(self):
        ...
        if self.switch_frame == 0:
            ...
            if exp_folders:
                dir = str(self.image_select_folder) + '/' + str(exp_folders[0]) + '/labels/'
            else:
                pass
        elif self.switch_frame == 1:
            exp_folders = [carpeta for carpeta in os.listdir(self.video_select_folder) if carpeta.startswith("exp")]
            exp_folders.sort(reverse=True)
            if exp_folders:
                dir = str(self.video_select_folder) + '/' + str(exp_folders[0]) + '/labels/'
            else:
                pass
        else:
            exp_folders = [carpeta for carpeta in os.listdir(self.streaming_select_folder) if carpeta.startswith("exp")]
            exp_folders.sort(reverse=True)
            if exp_folders:
        ...
        plt.axis('equal')
        if self.switch_frame == 0:
            plt.savefig(str(self.image_select_folder)+'/exp/'+'infographic.jpg')
            infographic_image = cv2.imread(str(self.image_select_folder)+'/exp/'+'infographic.jpg')
        elif self.switch_frame == 1:
            ...
            plt.savefig(str(self.streaming_select_folder)+'/exp/'+'infographic.jpg')
            infographic_image = cv2.imread(str(self.streaming_select_folder)+'/exp/'+'infographic.jpg')
        cv2.imshow('Infografia',infographic_image)
        while True:
            if cv2.getWindowProperty('Infografia',cv2.WND_PROP_VISIBLE)<1:
                break
            k = cv2.waitKey(1)
            if k == 27:
                break
